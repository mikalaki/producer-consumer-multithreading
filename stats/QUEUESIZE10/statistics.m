%% Graphs and statistics for the multiple prod-cons waiting time measurements ,QUEUESIZE=10
clear all;
format long

%% STATS calculations of all the DATA
LOOP=10000;
...
title("Mean waiting time of a function.(QUEUESIZE=10)");
...
title("Max waiting time of a function.(QUEUESIZE=10)");
xlabel("Number of consumer threads q");
...
title("Min waiting time of a function.(QUEUESIZE=10)");
xlabel("Number of consumer threads q");
...
title("Mean waiting time for first 3/4 of executions (QUEUESIZE=10)");
xlabel("Number of consumer threads q");
ylabel("Mean waiting time in microseconds (usec)");
