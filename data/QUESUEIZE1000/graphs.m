%% Graphs for the multiple prod-cons mean waiting time measurements ,QUEUESIZE=1000
...
% semilogy(data(dataToShow,2), data(dataToShow,3),'-*');
% hold on;
% 
%plotting Q=2
...
title("Average mean waiting time of a function.(QUEUESIZE=1000)");
